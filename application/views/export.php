 ...
 <body>
      <main>
           ...
           <table border="1" width="100%">
                ...
                <tr>
                    <td colspan="6">
                        Instansi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :&nbsp; (kode_instansi) &nbsp; (Nama_instansi) <br>
                        Sasaran RPJMD &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp; (sasaran_program) <br>
                        Program &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp; (kode_program) &nbsp; (nama_program) <br>
                        Kegiatan &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp; (kode_kegiatan) &nbsp; (nama_kegiatan) <br>
                ...
                <tr>
                    <td>(kode_rekening)</td>
                    <td>(nama_rekening)<br> (detail_rekening)</td>
                    <td>(volume)</td>
                    <td>(satuan)</td>
                    <td>(harga_satuan)</td>
                    <td>(jumlah)</td>
